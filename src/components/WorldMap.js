...
class WorldMap extends Component {
    ...
    render() {
        if (this.props.selectedProjection === "geoHill") {
            console.log("should read geoHill: "+this.props.selectedProjection);
            return (
                <div>
                    <Button
                        color="light"
        ...
        } else if (this.props.selectedProjection==="geoConicEqualArea") {
            console.log("should read geoConicEqualArea: "+this.props.selectedProjection);
            return (
                <div>
                    <Button
                        color="light"
            ...
            console.log("could be empty or read geoMercator: "+this.props.selectedProjection);
            return (
                <div>
                    <Button
                        color="light"
                ...
                >
                    ...
                    <svg width={ 800 } height={ 450 } viewBox="0 0 800 450">
                        <g className="countries">
                        {
                            ...
                            <path
                                key={ `path-${ i }` }
                                d={ geoPath().projection(this.projectionMercator())(d) }
                                className="country"
                                fill={ `rgba(38,250,56,${1 / this.props.worldData.length * i + .1})` }
                                stroke="#FFFFFF"
                                strokeWidth={ 0.5 }
